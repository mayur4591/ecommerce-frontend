                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-50 text-sm font-medium text-indigo-600 hover:text-indigo-500'>2479 Reviews</p>
                                </div>
                            </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5} paddingLeft={50}>
                                ...
                                <Box className='mt-5 space-y-3'>
                                    ...
                                    <Grid item xs={7}>
                                        <LinearProgress sx={{bgcolor:'#d0d0d0', borderRadius:4, height:7,  color:'blue'}} 
